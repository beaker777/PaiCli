...
/**
 * @Author beaker
 * @Date 2026/9/16 20:51
 * @Description Embedding 客户端, 支持 Ollama 和 OpenAI 兼容的 API
 */
public class EmbeddingClient {
    ...
    public float[] embed(String text) throws IOException {
        ...
        return switch (provider.toLowerCase()) {
            ...
            case "openai", "zhipu", "glm" -> embeddingOpenAICompatible(input);
    ...
    private float[] embeddingOpenAICompatible(String text) throws IOException {
    ...
    private String postJson(String url, String jsonBody, boolean useAuth) throws IOException {
        ...
        // 添加 apiKey
        if (useAuth && apiKey != null && !apiKey.isBlank()) {
        ...
        try (Response response = HTTP_CLIENT.newCall(builder.build()).execute()) {
            ...
            if (!response.isSuccessful()) {
                String error = responseBody != null ? responseBody.string() : "无响应体";

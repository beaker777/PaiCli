...
/**
 * @Author beaker
 * @Date 2026/9/25 15:31
 * @Description Stdio, 启动一个子进程 Mcp Server 和主进程 Agent 交互
 */
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[paicode] stdout reader stopped: " + e.getMessage());
            }
        }, "paicode-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[paicode] stderr reader stopped: " + e.getMessage());
            }
        }, "paicode-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }

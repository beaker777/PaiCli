...
/**
 * @Author beaker
 * @Date 2026/9/27 00:30
 * @Description Token 使用格式化
 */
public class TokenUsageFormatter {

    public static String format(LlmClient llmClient, int inputTokens, int outputTokens, int cachedInputTokens, long startNanos) {

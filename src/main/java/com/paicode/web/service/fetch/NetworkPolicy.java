package com.paicode.web.service.fetch;
...
public class NetworkPolicy {
    ...
    public String checkUrl(String url) {
        ...
        if (scheme == null) {
            return "URL 缺少 scheme (需要 http 或 https)";
        }
    ...
    public String acquire() {
        ...
        if (current > maxPerWindow) {
            ...
            return String.format("请求过于频繁 (%d 秒内已达 %d 次上限), 在 %d 秒后重试",
                    windowMillis / 1000L, maxPerWindow, Math.max(1L, resetIn));
        }
        return null;
    }

...
/**
 * @Author beaker
 * @Date 2026/9/22 23:18
 * @Description 审批请求, 描述一次待确认的工具调用
 */
public record ApprovalRequest(String toolName, String arguments,
    ...
    private static final int FILED_WIDTH = BOX_INNER_WIDTH - 8;
     ...
     * 对长字符串（通常是 write_file 的 content）展示前若干个字符 + 总长度摘要。
